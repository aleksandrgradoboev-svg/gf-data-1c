...
Продукт `gt-data-1c` (© 2026 ООО Гринтех, MIT) включает или использует перечисленное ниже.
...
ООО Гринтех с нуля и покрывается лицензией продукта. Стороннего кода не содержит.
