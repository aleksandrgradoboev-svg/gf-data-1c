...
Готовые инструменты считают то же самое БЕЗ языка запросов, ошибиться синтаксисом в них нельзя:
  gt-data-1c_accounts - остатки и обороты по счёту (помесячно, по субсчетам)
  gt-data-1c_register - итоги регистра накопления
  gt-data-1c_slice    - регистр сведений на дату
  gt-data-1c_count    - сколько записей
...
Полная страница по любой теме - gt-data-1c_syntax: 52 тысячи страниц справки вендора для
